<link rel="stylesheet" type="text/css" href="<?=base_url()?>stylesheets/interests.css">
...
<div class="left_col">
	...
	<div class="interest-buttons">
		<a class="button-element-small cancel" href="<?=base_url()?>index.php/<?php echo $tag_item['type'];?>/edit/<?php echo $tag_item['item_id'];?>">Cancel</a>
