		...
		<div id="container">
			...
			<div class="content">
				...
				<div class="welcome-text">
					...
					<p>
						You can browse through individual students looking for MQPs, or search for project groups that still need members. You can also see advisors and the projects that they are offering.
					</p>
					<p>
						To use ProjectSpot, login with your WPI username and password.
					</p>
					<p>
